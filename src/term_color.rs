    ...
    pub fn sequence(self, color: Color) -> &'static [u8] {
        ...
        match self {
            TermColor::TrueColor => match color {
                ...
                Yellow => rgb_color!(fg, 0xd7, 0x99, 0x21).as_bytes(),
                BrightYellow => rgb_color!(fg, 0xfa, 0xbd, 0x2f).as_bytes(),
            ...
            TermColor::Extended256 => match color {
                ...
                Yellow => b"\x1b[38;5;172m",
                BrightYellow => b"\x1b[38;5;214m",
